...
MODEL                = Multuplexacion_FDM
MODULES              = rt_logging.c Multuplexacion_FDM.c Multuplexacion_FDM_capi.c Multuplexacion_FDM_data.c Multuplexacion_FDM_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = Multuplexacion_FDM.exe
MAKEFILE             = Multuplexacion_FDM.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/Usuario/Desktop/ENTREG~1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Multuplexacion_FDM_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Multuplexacion_FDM \
